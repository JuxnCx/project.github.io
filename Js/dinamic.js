...
$(document).ready(function() {
            ...
            function showOverlay(info, imageUrl) {
                ...
                <div class="ui modal rounded transparent" style="max-width: 100% !important; overflow-y: auto;">
                    ...
                    <div class="content" > <!-- Reducir el margin-bottom a 20px o ajustar según sea necesario -->
                        ${imageUrl ? `<img src="${imageUrl}" alt="Imagen de Wikipedia" style="max-width: 100%; max-height: 500px; float: left; margin-right: 15px;">` : ''}
                        <p>${info}</p>
                    </div>
                    <div class="actions">
            ...
            `;
                ...
                $('.ui.modal')
                    ...
                    .modal('show')
                    .find('.content img')
                    .css('max-width', '100%') // Ajuste del ancho máximo de la imagen
                    .css('max-height', '100%'); // Ajuste de la altura máxima de la imagen
